...
public class Selftrap extends Module
{
    ...
    public Selftrap() {
        ...
        this.blocksPerTick = this.register(new Setting<>("BlocksPerTick", 8, 1, 20));
        this.delay = this.register(new Setting<>("Delay", 0, 0, 250));
        this.rotate = this.register(new Setting<>("Rotate", false));
        this.disableTime = this.register(new Setting<>("DisableTime", 300, 50, 300));
        this.disable = this.register(new Setting<>("AutoDisable", false));
        this.packet = this.register(new Setting<>("PacketPlace", true));
