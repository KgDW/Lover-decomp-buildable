...
public class Offhand extends Module
{
    ...
    public Offhand() {
        ...
        this.crystalHealth = this.register(new Setting<>("CrystalHP", 13.0f, 0.1f, 36.0f));
        this.crystalHoleHealth = this.register(new Setting<>("CrystalHoleHP", 3.5f, 0.1f, 36.0f));
        this.gapple = this.register(new Setting<>("Gapple", true));
        this.armorCheck = this.register(new Setting<>("ArmorCheck", true));
        this.actions = this.register(new Setting<>("Packets", 4, 1, 4));
