...
public class Replenish extends Module
{
    ...
    public Replenish() {
        ...
        this.delay = this.register(new Setting<>("Delay", 0, 0, 10));
        this.gapStack = this.register(new Setting<>("GapStack", 1, 50, 64));
        this.xpStackAt = this.register(new Setting<>("XPStack", 1, 50, 64));
