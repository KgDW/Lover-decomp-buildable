package dev.blackhig.zhebushigudu.lover.util.render;
    ...
    public static Map<String, Integer> getTextRadarPlayers() {
        ...
        for (final EntityPlayer player : EntityUtil.mc.world.playerEntities) {
            if (!player.isInvisible()) {
                ...
                output.put(healthSB.toString() + " " + (lover.friendManager.isFriend(player) ? ChatFormatting.AQUA : ChatFormatting.RED) + player.getName() + " " + distanceSB.toString() + " \u00c2¡±f0", (int)EntityUtil.mc.player.getDistance((Entity)player));
    ...
    public static boolean getSurroundWeakness(final Vec3d pos, final int feetMine, final int render) {
        switch (feetMine) {
            case 1: {
                ...
                final Block blocka;
                final Block blockb;
                if ((block != Blocks.OBSIDIAN && block != Blocks.OBSIDIAN) || ((blocka = EntityUtil.mc.world.getBlockState(new BlockPos(pos).add(-2, 0, 0)).getBlock()) != Blocks.OBSIDIAN && blocka != Blocks.OBSIDIAN) || ((blockb = EntityUtil.mc.world.getBlockState(new BlockPos(pos).add(-2, -1, 0)).getBlock()) != Blocks.OBSIDIAN && blockb != Blocks.OBSIDIAN)) {
                    break;
                }
                if (EntityUtil.mc.world.getBlockState(new BlockPos(pos).add(-1, 0, 0)).getBlock() == Blocks.OBSIDIAN) {
                    break;
                }
                return true;
            }
            ...
            case 3: {
                ...
                final Block blocka;
                final Block blockb;
                if ((block != Blocks.OBSIDIAN && block != Blocks.OBSIDIAN) || ((blocka = EntityUtil.mc.world.getBlockState(new BlockPos(pos).add(0, 0, -2)).getBlock()) != Blocks.OBSIDIAN && blocka != Blocks.OBSIDIAN) || ((blockb = EntityUtil.mc.world.getBlockState(new BlockPos(pos).add(0, -1, -2)).getBlock()) != Blocks.OBSIDIAN && blockb != Blocks.OBSIDIAN)) {
                    break;
                }
                if (EntityUtil.mc.world.getBlockState(new BlockPos(pos).add(0, 0, -1)).getBlock() == Blocks.OBSIDIAN) {
                    break;
                }
                return true;
            }
            ...
            case 5: {
                ...
                if (block2 != Blocks.OBSIDIAN && block2 != Blocks.OBSIDIAN) {
                    break;
                }
                if (EntityUtil.mc.world.getBlockState(new BlockPos(pos).add(-1, 0, 0)).getBlock() == Blocks.OBSIDIAN) {
                    break;
        ...
        switch (render) {
            case 1: {
                ...
                final Block blocka;
                final Block blockb;
                return (block3 == Blocks.AIR || block3 == Blocks.FIRE) && ((blocka = EntityUtil.mc.world.getBlockState(new BlockPos(pos).add(-2, 0, 0)).getBlock()) == Blocks.AIR || blocka == Blocks.FIRE) && ((blockb = EntityUtil.mc.world.getBlockState(new BlockPos(pos).add(-2, -1, 0)).getBlock()) == Blocks.OBSIDIAN || blockb == Blocks.BEDROCK) && EntityUtil.mc.world.getBlockState(new BlockPos(pos).add(-1, 0, 0)).getBlock() != Blocks.BEDROCK;
            }
            case 2: {
                final Block block3 = EntityUtil.mc.world.getBlockState(new BlockPos(pos).add(2, 1, 0)).getBlock();
                final Block blocka;
            ...
            case 3: {
                ...
                final Block blocka;
                final Block blockb;
                return (block3 == Blocks.AIR || block3 == Blocks.FIRE) && ((blocka = EntityUtil.mc.world.getBlockState(new BlockPos(pos).add(0, 0, -2)).getBlock()) == Blocks.AIR || blocka == Blocks.FIRE) && ((blockb = EntityUtil.mc.world.getBlockState(new BlockPos(pos).add(0, -1, -2)).getBlock()) == Blocks.OBSIDIAN || blockb == Blocks.BEDROCK) && EntityUtil.mc.world.getBlockState(new BlockPos(pos).add(0, 0, -1)).getBlock() != Blocks.BEDROCK;
            }
            case 4: {
                final Block block3 = EntityUtil.mc.world.getBlockState(new BlockPos(pos).add(0, 1, 2)).getBlock();
                final Block blocka;
