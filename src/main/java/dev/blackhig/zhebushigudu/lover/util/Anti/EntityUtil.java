...
import dev.blackhig.zhebushigudu.lover.util.e.MathUtil;
...
import dev.blackhig.zhebushigudu.lover.util.e.BlockUtil;
    ...
    public static boolean getSurroundWeakness(final Vec3d pos, final int feetMine, final int render) {
        switch (feetMine) {
            case 1: {
                ...
                final Block blocka;
                final Block blockb;
                if ((block != Blocks.AIR && block != Blocks.FIRE) || ((blocka = EntityUtil.mc.world.getBlockState(new BlockPos(pos).add(-2, 0, 0)).getBlock()) != Blocks.AIR && blocka != Blocks.FIRE) || ((blockb = EntityUtil.mc.world.getBlockState(new BlockPos(pos).add(-2, -1, 0)).getBlock()) != Blocks.OBSIDIAN && blockb != Blocks.BEDROCK)) {
                    break;
                }
            ...
            case 3: {
                ...
                final Block blocka;
                final Block blockb;
                if ((block != Blocks.AIR && block != Blocks.FIRE) || ((blocka = EntityUtil.mc.world.getBlockState(new BlockPos(pos).add(0, 0, -2)).getBlock()) != Blocks.AIR && blocka != Blocks.FIRE) || ((blockb = EntityUtil.mc.world.getBlockState(new BlockPos(pos).add(0, -1, -2)).getBlock()) != Blocks.OBSIDIAN && blockb != Blocks.BEDROCK)) {
                    break;
                }
